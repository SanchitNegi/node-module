    ...
    <div class="row">        
		...
		<?php echo $this->Form->input('User.phone',array('type'=>'text','class'=>'form-control','placeholder'=>'Enter Your Phone number','maxlength'=>'12','div'=>false));
		...
		<?php echo $this->Form->input('User.changepassword',array('type'=>'checkbox','class'=>'passwrd-input','placeholder'=>'Date of Birth','maxlength'=>'12','label'=>'Change Password'));?>
