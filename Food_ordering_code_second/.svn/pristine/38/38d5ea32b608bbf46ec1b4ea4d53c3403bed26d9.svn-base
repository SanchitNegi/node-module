<div class="row">
  ...
  'default'=>1
                ...
                echo $this->Form->error('Store.is_active');
                   ...
                   ?>
		   <span class="blue">(Please select navigation for front end)</span>
	       </div>
               <div class="col-lg-2">		 
	    ...
	    <table class="table table-bordered table-hover table-striped tablesorter">
	       <thead>
		     <tr>	    
			<th  class="th_checkbox"><?php echo $this->Paginator->sort('StoreContent.name', 'Page');?></th>
			<th  class="th_checkbox"><?php echo $this->Paginator->sort('StoreContent.created', 'Created');?></th>
		  ...
		  if($list){
			...
			<td><?php echo $data['StoreContent']['name'] ;?></td>
                     ...
                     <td>
			  <?php echo $data['StoreContent']['created'] ;?>
		    </td>
                        <td>
			   <?php
