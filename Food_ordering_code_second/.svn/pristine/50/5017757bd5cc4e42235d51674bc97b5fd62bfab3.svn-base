...
class StoreGallery extends AppModel { 
	 ...
	 public function getStoreSliderImages($storeID=null,$merchantID=null){
                    $storeSliderImages = $this->find('all',array('conditions'=>array('StoreGallery.store_id'=>$storeID,'StoreGallery.merchant_id'=>$merchantID,'StoreGallery.is_deleted'=>0),'fields'=>array('StoreGallery.id','StoreGallery.store_id','StoreGallery.merchant_id','StoreGallery.image','StoreGallery.description')));
