	 ...
	 <?php echo $this->Session->flash();?> 
		...
		<div class="col-lg-3">		     
	       ...
	       <div class="col-lg-3">		     
		    ...
		    echo $this->Form->input('Size.is_active',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$options,'empty'=>'Select Status')); ?>		
	       </div>
...
<script>
	...
	$("#SizeCategoryId").change(function(){
	    var sizeId=$("#SizeCategoryId").val();
	    $("#AdminId").submit();
	});
