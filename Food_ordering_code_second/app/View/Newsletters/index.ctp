<?php echo $this->Html->script('ckeditor/ckeditor');?>
    ...
    <div class="row">        
	   ...
	   <div class="form-group form_margin">		 
		...
		<?php echo $this->Form->input('Newsletter.name',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Enter Type','label'=>'','div'=>false));
		...
		<?php echo $this->Form->input('Newsletter.content_key',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Enter Type','label'=>'','div'=>false));
                  echo $this->Form->error('Newsletter.content_key'); ?>
            </div>
	    <div class="form-group form_spacing">
                <label>Body</label> 
                <?php echo $this->Form->textarea('Newsletter.content',array('class'=>'ckeditor'));
