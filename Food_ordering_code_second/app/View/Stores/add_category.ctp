    ...
    <div class="row">        
	    ...
	    <div class="form-group form_margin">
                ...
                <?php 
                echo $this->Form->input('Category.is_meal',array('label'=>false,'div'=>false,'type'=>'checkbox','id'=>'<?php echo $this->Form->input('StoreAvailability.'.$key.'.end_time',array('options'=>$timeOptions,'value'=>$data['StoreAvailability']['end_time'],'class'=>'passwrd-input ','maxlength'=>'50','div'=>false));?>'))."&nbsp";?><span>Is Meal</span>  
                ?>
            </div>
