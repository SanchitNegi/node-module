<?php App::uses('AppModel','Model');  
  ...
  -----------------------------------------------------*/
    ...
    /*------------------------------------------------
        ...
        created:20/8/2015
    -----------------------------------------------------*/
    public function getValidCoupon($couponCode=null,$storeId=null){      
        $couponDetail = $this->find('first',array('conditions'=>array('Coupon.store_id'=>$storeId,'Coupon.coupon_code'=>$couponCode,'Coupon.is_active'=>1,'Coupon.is_deleted'=>0)));     
        return $couponDetail;
