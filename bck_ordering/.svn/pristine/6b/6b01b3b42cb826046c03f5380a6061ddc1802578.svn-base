<style>
  ...
  'default'=>1
		...
		<?php echo $this->Form->input('Coupon.discount',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Enter discount','label'=>'','div'=>false));
	   ...
	   <?php echo $this->Form->input('Coupon.number_can_use',array('type'=>'number','min'=>'1','class'=>'form-control valid','placeholder'=>'Enter no of times use','label'=>'','div'=>false));
