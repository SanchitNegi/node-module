...
class AppController extends Controller {
        ...
        public function beforeFilter() {
            ...
            $this->Auth->allow('accountActivation','fetchCoupon','items','fetchProduct','sizePrice','fetchToppingPrice','fetchCategoryInfo','cart','removeItem','addQuantity','orderDetails','cancelOffer','orderSave','success','status','guestOrdering','login','registration','store','checkEmail','forgetPassword','selectStore','paymentSection');
