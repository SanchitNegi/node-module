...
class UserCoupon extends AppModel {
    ...
    public function getCouponDetails($decrypt_merchantId=null,$decrypt_storeId=null,$decrypt_userId=null){
        $myCoupons = $this->find('all',array('conditions'=>array('UserCoupon.merchant_id'=>$decrypt_merchantId,'UserCoupon.user_id'=>$decrypt_userId,'UserCoupon.store_id'=>$decrypt_storeId,'UserCoupon.is_active'=>1,'UserCoupon.is_deleted'=>0)));
        return $myCoupons;
    }
