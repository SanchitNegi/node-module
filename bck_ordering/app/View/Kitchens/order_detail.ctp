...
<div class="row">
	 ...
	 <?php echo $this->Session->flash();?> 
		...
		<div class="col-lg-2">		     
	       ...
	       <div class="col-lg-2" style="float:right;">		 
		     <?php echo $this->Html->link('Back',array('controller'=>'kitchens','action'=>'index','clear'),array('class' => 'btn btn-default'));?>
	       </div>
	       <div class="col-lg-2">		  
		  
	       </div>
	    </div>
	 <?php echo $this->Form->create('Kitchen', array('action'=>'UpdateOrderStatus','controller'=>'kitchens','inputDefaults' => array('label' => false, 'div'=>false, 'required' => false, 'error' => false, 'legend' => false,'autocomplete' => 'off'),'id'=>'CategoryAdd','enctype'=>'multipart/form-data'));?>
	...
	<table class="table table-bordered table-hover table-striped tablesorter">
		...
		Order Id  : <?php  echo $orderDetail[0]['Order']['order_number'] ;?> | Cost :  $<?php  echo $orderDetail[0]['Order']['amount'] ;?> | Status : <?php
		              $data =  $this->requestAction('/kitchens/ajaxRequest/'.$orderDetail[0]['Order']['order_status_id'].'');
...
<?php echo $this->Form->button('Update Status', array('type' => 'submit','class' => 'btn btn-default'));            
                         ...
                         ?>                     
<?php echo $this->Html->link('Cancel', "/kitchens/index/", array("class" => "btn btn-default",'escape' => false)); ?>
